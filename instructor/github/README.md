...
4. You may also edit the Test Prepend and Test Postpend. These are programs that will be appended to the learner's code. You can use this to set up variables or define helper functions for your tests.
